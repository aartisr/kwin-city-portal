...
export const metadata: Metadata = {
  ...
  description:
    'KWIN City is a proposed 465-acre knowledge-economy township in Doddaballapura, North Bengaluru. Semiconductors, aerospace, health-tech, renewables and R&D — designed net-zero and evidence-first.',
  alternates: {
