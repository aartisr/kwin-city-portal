          ...
          {status === 'success' ? (
            ...
            >
              <input
                ...
                className="w-full bg-white/8 border border-white/12 rounded-xl px-4 py-2.5 text-[#C8D8E8] placeholder-[#B7C8DA] text-sm outline-none focus:border-amber-400/60 transition-colors"
              />
              <input
                type="email"
                name="email"
