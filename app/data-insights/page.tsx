    ...
    <SiteFrame>
      <main id="main-content" role="main">
              ...
              {[
                ...
                <div key={item.step} className="px-8 py-7">
                  ...
                  <dd>
                    ...
                    <p className="kwin-text-on-dark-muted text-sm leading-relaxed">{item.desc}</p>
                  </dd>
                </div>
              ))}
            </dl>
        ...
        <section className="py-8 bg-[#040714] border-t border-white/8">
          <div className="container">
            <p className="kwin-text-on-dark-muted mx-auto max-w-3xl text-center text-xs leading-relaxed">
