...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      'next/headers': path.resolve(__dirname, './shims/next/headers.ts'),
      ...
      'next/dynamic': path.resolve(__dirname, './shims/next/dynamic.tsx'),
      'next/cache': path.resolve(__dirname, './shims/next/cache.ts'),
      'next/og': path.resolve(__dirname, './shims/next/og.ts'),
      'next': path.resolve(__dirname, './shims/next/index.ts'),
    },
  },
});
