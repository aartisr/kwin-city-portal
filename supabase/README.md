...
- Never edit an applied migration. Add a file with the next unused number (currently `0003_descriptive_change.sql`), then update the domain model and its repository adapter.
