...
- Interactive intelligence contract: flagship workflows, WebApplication discovery, shareable map state, saved views, and structured intake enforced
...
- Surfaced three flagship interactive workflows, published an attributable WebApplication catalog, and added shareable/saveable Spatial Explorer state.
